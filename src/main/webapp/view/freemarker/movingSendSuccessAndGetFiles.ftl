...
<#if success??>
    <div id="container">
        <center>
            ...
            <form action="/window/moving/send/report_general_list_of_product_error" method="post">
            ...
            <form action="/window/arrival/moving/report_stock_balances_error" method="post">

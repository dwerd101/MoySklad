...
<div id="container">
    <center>
        ...
        <form action="/window/arrival/send/report_general_list_of_product_error" method="post">
        ...
        <form action="/window/arrival/send/report_stock_balances_error" method="post">
